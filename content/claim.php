    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <div class="col-md-12" style="padding:35px;border: 1px solid #000;border-radius: 7px;background: #e9ecef;">
          <h4 style="font-weight: 300;line-height: 1.41667;text-transform: none;color: #29293a;text-align: left!important;">GET FREE TRX :: <span id="account-address" style="font-weight:bold;"></span> : <span id="account-balance"></span></h4>
                  ...
                  <div class="modal-new" style="padding: 60px">
                    ...
                    <form action="solve.php" method="post" id="logsubmit">
                      <div class="form-group">
                        <span id="capt"><center><?php echo solvemedia_get_html("xLxIw6ibOZWL52J97WjID7wkCMJzave8", null, true); ?></center></span><br>
                      </div>
